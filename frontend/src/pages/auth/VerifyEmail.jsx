    ...
    >
      ...
      >
        <div className="login-header verify-email-header">
          ...
          <p>
            {status === "success"
              ? "Your email address has been successfully verified. You can now log in to your account and get started."
              : messageParam === "UserNotFound"
                ? "No user found with this email address. The link might be incorrect."
                : messageParam === "InvalidToken"
        ...
        {status === "success" ? (
          <Link to="/" className="action-link">
            <button className="submit-btn action-btn">Log In</button>
          </Link>
        ) : (
          <div className="action-btn-group">
            ...
            <Link to="/" className="action-link">
              <button className="google-btn action-btn">Back to Login</button>
            </Link>
          </div>
        )}
      </motion.div>
